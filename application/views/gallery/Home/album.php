    ...
    <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <div class="text-muted mt-1 text-danger">1-6 of 6 Album</div>
                </div>
                <!-- Page title actions -->
        ...
        <div class="container-xl">
            <div class="row row-cards">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card">
                        <!-- Photo -->
                        <div class="img-responsive img-responsive-21x9 card-img-top" style="background-image: url(<?= base_url('dist/img/gambar/Hutan.jpg') ?>)"></div>
                        <div class="card-body">
